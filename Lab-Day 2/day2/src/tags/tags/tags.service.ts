...
import { Tags } from 'src/core/schemas/tags.shecma';
import { tagDTO } from './dto/tag.tdo';

@Injectable()
export class TagsService {
  constructor(@InjectModel(Tags.name) private tagModule : Model<Tags>){}


  // To add Tags
  async addTag(body : tagDTO){
    let tag = await this.tagModule.insertMany(body)
    return "Tag Created"
  }
